...
const Basic = ({backgroundImage, statusBarBackgroundColor, statusBarTranslucent = false, hiddenStatusBar = false, headerBar = false, headerBarStyle, headerTitle, headerTitleStyle, headerColor}) => (
    <React.Fragment>
        <StatusBar barStyle="dark-content" backgroundColor={statusBarBackgroundColor ? statusBarBackgroundColor : white} translucent={statusBarTranslucent} hidden={hiddenStatusBar} />
